...
public class DefaultSpeciesSet
{
    ...
    private readonly List<IReporter> _reporters; // Replace `IReporter` with reporter interface type.
    ...
    public DefaultSpeciesSet(Config config, List<IReporter> reporters)
    {
        _config = config;
